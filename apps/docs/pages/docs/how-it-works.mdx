...
## SSR Considerations
For SSR, you can rely on page hydration.
Rendering the first set of items on the server and then hydrate the rest on the client.
...
- Your dataset is not that large
